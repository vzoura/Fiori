		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync6cl1flightschedule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1flightschedule-display": {
								"semanticObject": "sync6cl1flightschedule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.flightschedule",
									"url": sap.ui.require.toUrl("sync6/cl1/flightschedule")
								}
							}
						}
					}
