		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Airline Master",
									"targetURL": "#sync6cl1sync6cl1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1sync6cl1-display": {
								"semanticObject": "sync6cl1sync6cl1",
								"action": "display",
								"description": "UI5 Airline Master",
								"title": "UI5 Airline Master",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.sync6cl1",
									"url": sap.ui.require.toUrl("sync6/cl1/sync6cl1")
								}
							}
						}
					}
