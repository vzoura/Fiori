		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Airline Schedule",
									"targetURL": "#sync6cl1spflisync6cl1spfli-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1spflisync6cl1spfli-display": {
								"semanticObject": "sync6cl1spflisync6cl1spfli",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.spfli.sync6cl1spfli",
									"url": sap.ui.require.toUrl("sync6/cl1/spfli/sync6cl1spfli")
								}
							}
						}
					}
