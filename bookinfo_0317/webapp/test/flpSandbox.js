		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Seats data",
									"targetURL": "#seatsdatabookinfo0317-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"seatsdatabookinfo0317-display": {
								"semanticObject": "seatsdatabookinfo0317",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=seatsdata.bookinfo0317",
									"url": sap.ui.require.toUrl("seatsdata/bookinfo0317")
								}
							}
						}
					}
