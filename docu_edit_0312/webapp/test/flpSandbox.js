		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FI Document edit",
									"targetURL": "#sync6cl1docuedit0312-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1docuedit0312-display": {
								"semanticObject": "sync6cl1docuedit0312",
								"action": "display",
								"description": "FI Document edit",
								"title": "FI Document edit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.docuedit0312",
									"url": sap.ui.require.toUrl("sync6/cl1/docuedit0312")
								}
							}
						}
					}
