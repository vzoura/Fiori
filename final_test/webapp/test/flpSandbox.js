		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FI_Document_edit",
									"targetURL": "#finaltestfinaltest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"finaltestfinaltest-display": {
								"semanticObject": "finaltestfinaltest",
								"action": "display",
								"description": "FI_Document_edit",
								"title": "FI_Document_edit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=finaltest.finaltest",
									"url": sap.ui.require.toUrl("finaltest/finaltest")
								}
							}
						}
					}
