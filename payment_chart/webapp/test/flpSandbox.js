		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airline price chart",
									"targetURL": "#sync6cl1paymentchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1paymentchart-display": {
								"semanticObject": "sync6cl1paymentchart",
								"action": "display",
								"description": "Airline price chart",
								"title": "Airline price chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.paymentchart",
									"url": sap.ui.require.toUrl("sync6/cl1/paymentchart")
								}
							}
						}
					}
