		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FlightInfo Service",
									"targetURL": "#flightinfo0314flightinfo0314-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flightinfo0314flightinfo0314-display": {
								"semanticObject": "flightinfo0314flightinfo0314",
								"action": "display",
								"description": "FlightInfo Service",
								"title": "FlightInfo Service",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flightinfo0314.flightinfo0314",
									"url": sap.ui.require.toUrl("flightinfo0314/flightinfo0314")
								}
							}
						}
					}
