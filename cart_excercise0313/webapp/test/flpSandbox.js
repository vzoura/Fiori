		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "cart_excercise0313",
									"targetURL": "#sync6cl1cartexcercise0313-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1cartexcercise0313-display": {
								"semanticObject": "sync6cl1cartexcercise0313",
								"action": "display",
								"description": "cart_excercise0313",
								"title": "cart_excercise0313",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.cartexcercise0313",
									"url": sap.ui.require.toUrl("sync6/cl1/cartexcercise0313")
								}
							}
						}
					}
